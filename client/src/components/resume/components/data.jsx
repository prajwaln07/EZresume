...
export default{
    ...
    linkedin:'',
    themeColor:"#ff6666",
    summery:'Passion for growth and a drive for success fuel my ambition to continuously learn and adapt in an ever-changing world. With a focus on innovation and efficiency, I strive to contribute meangfully  in all my endeavors',
    experience:[
        {
            id:1,
