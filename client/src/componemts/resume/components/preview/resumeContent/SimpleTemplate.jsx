...
const SimpleTemplate = ({ resumeInfo, resumeRef }) => {
  return (
    <div
      ref={resumeRef}
      className="w-full max-w-4xl mx-auto p-8 bg-white border border-gray-300 rounded-md font-sans text-gray-800"
    >
      {/* Header Section */}
      ...
      {resumeInfo?.summery && (
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">{resumeInfo.summery}</p>
        </div>
      )}
